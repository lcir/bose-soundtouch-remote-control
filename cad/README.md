...
- `assembly`: vizuální sestava s referenčními bloky pro `OLED`, `S2 Mini` a enkodér
...
- dvě malá `NO` tlačítka s čelním otvorem kolem `7.2 mm`
- samostatnou stavovou LED s otvorem `3.2 mm`
